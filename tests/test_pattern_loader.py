"""
Comprehensive tests for pattern_loader.py with 95%+ coverage.

Tests EventPattern creation, PatternLoader initialization, YAML file loading,
pattern filtering, validation, error handling, and reload functionality.
"""
