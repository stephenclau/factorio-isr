"""
Comprehensive tests for health.py with 95%+ coverage.

Tests HealthCheckServer initialization, HTTP endpoints, start/stop lifecycle,
and integration with aiohttp.
"""
