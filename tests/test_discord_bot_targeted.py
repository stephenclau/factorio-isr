"""
Targeted tests for discord_bot.py to close remaining coverage gaps.

This module is designed to be used in addition to test_discord_bot_complete.py.

It focuses on:

- Error paths and logging branches
- Multi-server context chains (get_user_server / get_rcon_for_user)
- RCON monitoring helpers and breakdown embeds
- Under-covered and previously untested slash commands
"""
