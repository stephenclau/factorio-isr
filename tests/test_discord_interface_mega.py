"""
Comprehensive pytest suite for discord_interface.py.

Covers:
- WebhookDiscordInterface lifecycle and behavior
- BotDiscordInterface lifecycle, send_message, send_embed, test_connection
- DiscordInterfaceFactory (bot and webhook creation, helpers, edge cases)
"""
