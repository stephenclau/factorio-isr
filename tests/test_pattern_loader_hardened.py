"""
Comprehensive tests for pattern_loader_hardened.py with security validation coverage.

FIXES APPLIED:
- Updated assertion messages to match actual error text
- Removed caplog dependencies (structlog doesn't work with caplog by default)
- Simplified validation checks to test behavior, not logs
"""
